...
class AdminManagment : AppCompatActivity() {
    private lateinit var binding: ActivityAdminManagmentBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding= ActivityAdminManagmentBinding.inflate(layoutInflater)
    ...
    private fun inn1(){
        ...
        binding.btnevent.setOnClickListener(){
            val intent=Intent(this,Eventmng2::class.java)
            startActivity(intent)
        }
    }
}